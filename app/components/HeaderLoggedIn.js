...
function HeaderLoggedIn(props) {
  ...
  return (
    <div className="flex-row my-3 my-md-0">
      <a data-for="search" data-tip="Search" href="#" onClick={handleSeachClick} className="text-white mr-2 header-search-icon">
        <i className="fas fa-search"></i>
      </a>
      <ReactTooltip id="search" className="custom-tooltip" />{" "}
      <span onClick={handleChatClick} data-for="chat" data-tip="Chat" className="mr-2 header-chat-icon text-white">
